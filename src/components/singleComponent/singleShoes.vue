<template>
  <div class="singleShoes opa-anim">
    <div class="container" style="height: 95vh;">
      <div class="row mt-5">
        <div class="col-lg-6 app-flex-justify-content">
          <img :src="singleShoes.image" alt="Error" style="width:80%; height:330px; border-radius:5px;">
        </div>
        <div class="col-lg-6 app-flex-column app-flex-justify-content px-5 mt-2">
          ...
          <span class="app-text-size-z app-light-color">{{singleShoes.name}}</span>
          <span class="app-text-size-x app-light-color">Size</span>
          <span class="app-text-size-y app-light-color">{{singleShoes.size}}</span>
          <span class="app-text-size-x app-light-color">Price</span>
          <span class="app-text-size-y app-light-color">{{singleShoes.price}} $</span>
